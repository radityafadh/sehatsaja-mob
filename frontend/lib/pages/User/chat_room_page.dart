...
class _ChatRoomPageState extends State<ChatRoomPage> {
  ...
  void initState() {
    ...
    // Debug print for route parameters
    print('appointmentId: ${Get.parameters['appointmentId']}');
    print('doctorId: ${Get.parameters['doctorId']}');
    print('patientId: ${Get.parameters['patientId']}');
  ...
  Future<void> _sendImageMessage(String base64Image, String mimeType) async {
    final newMessage = {
      'image': base64Image,
      'mimeType': mimeType,
      'isDoctor': false, // User (patient) sends image to doctor
  ...
  void sendMessage(String text) {
    ...
    final newMessage = {
      'text': text.trim(),
      'isDoctor': false, // User (patient) sends text to doctor
      'timestamp': FieldValue.serverTimestamp(),
      'isImage': false,
    };
  ...
  void setTyping(bool typing) => isTyping.value = typing;
