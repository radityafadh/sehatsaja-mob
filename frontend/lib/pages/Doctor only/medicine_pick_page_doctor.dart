...
class MedicinePickPageDoctor extends StatefulWidget {
  const MedicinePickPageDoctor({Key? key}) : super(key: key);

  @override
  _MedicinePickStateDoctor createState() => _MedicinePickStateDoctor();
}

class _MedicinePickStateDoctor extends State<MedicinePickPageDoctor> {
