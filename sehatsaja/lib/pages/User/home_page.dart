...
import 'package:sehatsaja/pages/User/news_detail_page.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget _buildUpcomingAppointment() {
    ...
    final apptDate = DateTime.parse(upcomingAppointment!['appointmentDate']);
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(
                  isToday
                      ? 'Today • ${upcomingAppointment!['appointmentTime']}'
                      : '${DateFormat('MMM dd').format(apptDate)} • ${upcomingAppointment!['appointmentTime']}',
